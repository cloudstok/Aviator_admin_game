...
const PaginationComponent = ({ currentPage, totalPages, onPageChange, itemsPerPage, handleItemsPerPageChange }) => {
  const displayPageNumbers = 5; // Adjust the number of page numbers to display
