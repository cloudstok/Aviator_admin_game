    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            if (isAddMode) {
                ...
                const res = await updateCaller(`admin/v1/update/news/${getSingleNews.news_id}`, values)
                console.log(res)
                // if (res.status === 'success') {
                //   alert(res.message)
                //   navigate('/news')
    ...
    return (
        <>
                ...
                <div className="form-content">
                    <div>
                        <div className='form-heading'>
                            <p>{isAddMode ? "Add Match" : "Update Match"}</p>
                            <AiOutlineClose className='ai-close' onClick={() => navigate("/matches")} />
                        </div>
            ...
            {formik.errors.password}
                                ...
                                <div className="form-input-field">
                                    <label htmlFor="date"> Sub Heading <span style={{color: 'red'}}>*</span> </label> <br />
            ...
            {formik.errors.password}
                                ...
                                <div className="form-input-field">
                                    <label htmlFor="date"> Content <span style={{color: 'red'}}>*</span> </label> <br />
